%Generate Spaghetti Plots of trajectories 
%Nature Rebuttal 
%by Ercag 
%February 2019 
close all; 
...
title({Strain_Label,[num2str(total_number) ' cells']},'interpreter','none');

hf_1 = gcf;
%printfig(hf_1,[Export_Folder filesep Sample_Label '_SpaghettiPlot' ],'-dpdf')
savefig(hf_1,[Export_Folder filesep Sample_Label '_SpaghettiPlot.fig'])
...
%"total_number" is the total number of cells which have non-zero track length 
title({Strain_Label,[num2str(total_number) ' cells']},'interpreter','none');
printfig(hf_2,[Export_Folder filesep Sample_Label '_VelocitySpaghettiPlot' ],'-dpng')
savefig(hf_2,[Export_Folder filesep Sample_Label '_VelocitySpaghettiPlot.fig'])
