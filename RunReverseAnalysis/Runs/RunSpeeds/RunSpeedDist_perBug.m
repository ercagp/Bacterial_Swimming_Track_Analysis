%% Run speed distributions and other related plots per bug 
%January 2021
%by Ercag
...
function ExportFig(hf,Strings)
        ...
        FinalExpPath = fullfile(Strings.ExpPath,'RunSpeedsPerBug',Strings.PlotY,Strings.Strain,[Strings.IPTG 'uM']);
