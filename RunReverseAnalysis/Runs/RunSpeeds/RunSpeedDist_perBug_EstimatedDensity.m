...
function ExportFig(hf,Strings)
        ...
        FinalExpPath = fullfile(Strings.ExpPath,'RunSpeedsPerBug_HighlightedRuns','KernelDensityEstimation',Strings.PlotY,Strings.Strain,[Strings.IPTG 'uM']);
...
%         The input has now two components  
          ...
          ColorMap_Runs = linspecer(length(XValues),'sequential');
