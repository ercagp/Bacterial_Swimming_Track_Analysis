...
%December 2020 
%by Ercag
%v4 - This version includes "RunBreakDownv5" function which calculates run
%durations of all runs (complete + incomplete) 
clearvars;
close all; 

%% Define Export Path for figures
ExpPath = 'F:\Dropbox\Research\NikauBackup\Data\RunReverseAnalysis\RunAnalysis\SpeedAnalysis\Distributions\MeanRunSpeed';
...
%             end
    ...
    printfig(hf,fullfile(ExpPath,['[20201216][MeanRunSpeed]' StrainLabels{j}...
                '.pdf']),'-dpdf');
