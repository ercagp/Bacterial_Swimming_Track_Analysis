...
%Find .mat files
    ...
    for i = 1:length(Files) 
        ...
        Var.Ang = Results.Ang(:,3); %Turn Angle!  
        Var.T = Results.T;
        Var.Speeds = Speeds;
...
%         PlotQ(hf_Q,Q{i},PP);
 ...
 function hPlt = PlotQ(hf,Q,PltParameters)
          ...
          AngThresh = PltParameters.AngLow; 
          ...
          ExpPath = fullfile(GenExpPath,VideoDate,[StrainLabel '_' num2str(IPTG) 'uM'],ROI,'SpeedAnalysis','SpeedBeforeAfter_SharpTurn',['HigherThan' num2str(AngThresh) 'Degrees']);
