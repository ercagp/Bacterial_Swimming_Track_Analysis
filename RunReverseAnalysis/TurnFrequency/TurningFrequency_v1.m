...
ExpPath = 'F:\Dropbox\Research\NikauBackup\Data\RunReverseAnalysis';%'/Users/ercagpince/Dropbox/Research/NikauBackup/Data/RunReverseAnalysis/';
%% Call the run reverse analysis files 
MainPath = 'F:\Dropbox\Research\NikauBackup\Data\RunReverseAnalysis\Data';%'/Users/ercagpince/Dropbox/Research/NikauBackup/Data/RunReverseAnalysis/Data';
GenExpPath = MainPath; 
    ...
    for i = 1:length(Files) 
        ...
        switch observable 
            case 'TurnFreq_IPTG'
                  ...
                  %Note that Results.TotalTrajLength includes filtered traj. 
                  %This quantity is re-calculated below
                  ...
                  %TrajDur(i) = sum(cellfun(@(x) size(x(:,1),1)./fps, Speeds(FltMask)));
                  ...
                  if i == length(Files)
                     ...
                     if j == length(StrainLabels)
                        legend([pH{1:end}],StrainLabels,'Location','NorthEast')
                        %Export the figure 
                        S.ExpPath = ExpPath;
