...
Strain_Keyword = {'KMT11_Sample1','KMT11_Sample2'};
...
ax.Title.String = {'KMT11', 'Whole Population'};
...
printfig(hf_1,fullfile(Main_Export_Path,Video_Date, 'KMT9_AverageSpeedvsTime'),'-dpng')
printfig(hf_1,fullfile(Main_Export_Path,Video_Date, 'KMT9_AverageSpeedvsTime'),'-dpdf')
savefig(hf_1,fullfile(Main_Export_Path,Video_Date, 'KMT9_AverageSpeedvsTime'))
