%Correct Distribution of Weighted Mean Velocities for Individual ECOR
%by Ercag
%Nature Rebuttal 
%February 2019 
clearvars; 
...
%Set Title
title({ECOR_Label,'Weighted Mean Speed'})
ax_h1 = gca;
%Set Axes Titles
...
printfig(hf_1,[Export_Folder filesep Sample_Label '_WeightedMeanSpeed'],'-dpdf')
