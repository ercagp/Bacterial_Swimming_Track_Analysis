...
semedV = zeros(1,i_max);
 for i = 1:i_max
     ...
     semedV(i) = 1.253*SEMV(CB);%stdAllV(i)./sqrt(length(SpeedStats.allV));
 end
...
printfig(hf_1,fullfile(Main_Export_Path,Video_Date, 'KMT9_MMVFv3Test_MedianSpeedvsTime'),'-dpng')
printfig(hf_1,fullfile(Main_Export_Path,Video_Date, 'KMT9_MMVFv3Test_MedianSpeedvsTime'),'-dpdf')
savefig(hf_1,fullfile(Main_Export_Path,Video_Date, 'KMT9_MMVFv3Test_MedianSpeedvsTime'))
